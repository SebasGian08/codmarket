<div class="modal fade" id="modalCreate">
    <div class="modal-dialog modal-lg">
        ...
        <form action="{{ route('admin.variantes.store') }}" method="POST">
            @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="sku" class="form-control" placeholder="Ej: ZAP-NEG-42" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="codigo_barras" class="form-control" placeholder="Ej: 775412547845">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" name="precio_oferta" class="form-control">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <label class="attribute-check">
                                ...
                                <input type="checkbox" name="valores[]" value="{{ $v->id_valor }}">
